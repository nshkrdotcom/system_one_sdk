...
prepared = SystemOneSDK.prepare!(urgent: SystemOneSDK.noul("Does this describe an active outage?"))
...
SystemOneSDK.evaluate_stream(client, states, prepared,
  max_concurrency: 2,
  ordered: false,
  on_error: :raise,
  task_timeout_ms: 30_000,
