...
client = SystemOneSDK.Examples.Live.client()
SystemOneSDK.Examples.Live.show_configuration(client)
...
models = unwrap.(SystemOneSDK.list_models(client))
show.("Model list — SystemOneSDK.ListModelsResponse.models", models.models)
...
response = SystemOneSDK.system_one!(client, state, questions)

show.("Evaluation model — SystemOneSDK.SystemOneResponse.model", response.model)
show.("Structured answers — NoulAnswer, ChoiceAnswer, ScoreAnswer", response.answers)
show.("Token usage — SystemOneSDK.Usage", response.usage)
