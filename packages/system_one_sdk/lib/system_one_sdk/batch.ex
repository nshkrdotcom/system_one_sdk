defmodule SystemOneSDK.Batch do
  @moduledoc """
  ...
  """
  alias SystemOneSDK.Batch.Lifecycle
  alias SystemOneSDK.{Error, Evaluation, Prepared, SystemOneResponse, Telemetry}
  ...
  @spec stream(SystemOneSDK.Client.t(), Enumerable.t(), term(), keyword()) :: Enumerable.t()
  ...
  @spec many(SystemOneSDK.Client.t(), Enumerable.t(), term(), keyword()) :: list()
