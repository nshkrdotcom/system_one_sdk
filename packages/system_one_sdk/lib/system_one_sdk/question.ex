defmodule SystemOneSDK.Question do
  @moduledoc "Question validation and legacy wire normalization. Strict evaluation uses `SystemOneSDK.Prepared`."

  alias SystemOneSDK.{Choice, Error, Noul, Score}
