...
`SystemOneSDK.Client.new/1` accepts:
...
- `:retry` - `SystemOneSDK.RetryPolicy`, keyword/map options, or `false`
...
SystemOneSDK.list_models(client, timeout: 5, retry: false)
```
...
`test/system_one_sdk/live_example_configuration_test.exs`,
