defmodule SystemOneSDK.QuestionTest do
  use ExUnit.Case, async: true

  alias SystemOneSDK.{Choice, Noul, Question, Score}
  ...
  test "requires at least one question" do
    assert {:error, %SystemOneSDK.Error{type: :configuration, message: message}} =
  ...
  test "rejects score questions with an empty rubric" do
    assert {:error, %SystemOneSDK.Error{message: message}} =
