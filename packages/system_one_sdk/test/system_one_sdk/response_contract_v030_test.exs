defmodule SystemOneSDK.ResponseContractV030Test do
  ...
  test "default preserves unknown future answer entries" do
    ...
    assert {:ok, response} = SystemOneSDK.evaluate(client, "state", questions())
  ...
  test "strict unknown-answer policy fails closed with bounded metadata" do
    ...
    refute inspect(SystemOneSDK.Error.metadata(error)) =~ "secret-body-value"
  end
