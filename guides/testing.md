...
`SystemOneSDK.Test` injects a scripted implementation of `Pristine.Ports.Transport`.
...
client = SystemOneSDK.Test.stub(client, [
  team: {:choice, :billing,
...
client = SystemOneSDK.Test.stub_sequence(client, [
  {:http_error, 529},
