...
try do
  case SystemOneSDK.evaluate(client, query, useful: SystemOneSDK.noul("Is a search useful?")) do
    {:ok, response} ->
      if SystemOneSDK.Answer.yes?(SystemOneSDK.Response.fetch!(response, :useful), 0.85) do
