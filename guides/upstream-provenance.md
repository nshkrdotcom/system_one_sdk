...
The initial semantic reference is the supplied Python `system-one-sdk` 0.6.0
...
[the implementation source ledger](https://github.com/nshkrdotcom/system_one_sdk/blob/v0.2.0/docs/implementation/0.2.0/SOURCES_AND_DECISIONS.md)
