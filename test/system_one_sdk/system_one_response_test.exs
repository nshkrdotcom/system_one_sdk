defmodule SystemOneSDK.SystemOneResponseTest do
  use ExUnit.Case, async: true

  alias SystemOneSDK.{ChoiceAnswer, NoulAnswer, ScoreAnswer, SystemOneResponse}
  ...
  test "returns a response-validation error with a precise field path" do
    ...
    assert {:error, %SystemOneSDK.Error{type: :response_validation, field_path: path}} =
