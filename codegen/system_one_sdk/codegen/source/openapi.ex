defmodule SystemOneSDK.Codegen.Source.OpenAPI do
  alias SystemOneSDK.Codegen.Provider, as: Provider
  ...
  @schema_modules %{
    "ChoiceAnswer" => SystemOneSDK.Generated.Schemas.ChoiceAnswer,
    "ChoiceQuestion" => SystemOneSDK.Generated.Schemas.ChoiceQuestion,
    "ModelMetadata" => SystemOneSDK.Generated.Schemas.ModelMetadata,
    "ModelMetadataList" => SystemOneSDK.Generated.Schemas.ModelMetadataList,
    "NoulAnswer" => SystemOneSDK.Generated.Schemas.NoulAnswer,
    "NoulCriteria" => SystemOneSDK.Generated.Schemas.NoulCriteria,
    "NoulQuestion" => SystemOneSDK.Generated.Schemas.NoulQuestion,
    "ScoreAnswer" => SystemOneSDK.Generated.Schemas.ScoreAnswer,
    "ScoreQuestion" => SystemOneSDK.Generated.Schemas.ScoreQuestion,
    "SystemOneRequest" => SystemOneSDK.Generated.Schemas.SystemOneRequest,
    "SystemOneResponse" => SystemOneSDK.Generated.Schemas.SystemOneResponse,
    "Usage" => SystemOneSDK.Generated.Schemas.Usage
  }
  @operation_specs [
    %{
      id: "system_one",
      path: "/v1/systemone",
      method: :post,
      module: SystemOneSDK.Generated.SystemOne,
      function: :create,
      resource: "system_one"
    },
    %{
      ...
      path: "/v1/models",
      method: :get,
      module: SystemOneSDK.Generated.Models,
      function: :list,
      resource: "models"
    }
  ]
  ...
  defp schema_ref!("#/components/schemas/Question") do
    {:union,
     [
       {SystemOneSDK.Generated.Schemas.NoulQuestion, :t},
       {SystemOneSDK.Generated.Schemas.ChoiceQuestion, :t},
       {SystemOneSDK.Generated.Schemas.ScoreQuestion, :t}
     ]}
  end
