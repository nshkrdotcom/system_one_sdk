defmodule SystemOneSDK.Codegen.Provider do
  alias SystemOneSDK.Codegen.Source.OpenAPI, as: OpenAPI

  @moduledoc false
  @behaviour PristineCodegen.Provider

  alias SystemOneSDK.Constants
  ...
  def definition(_opts) do
    %{
      provider: %{
        id: :typesafe,
        base_module: SystemOneSDK,
        client_module: SystemOneSDK.Client,
        package_app: :system_one_sdk,
        package_name: "system_one_sdk",
        source_strategy: :openapi_snapshot
      },
      runtime_defaults: %{
        base_url: Constants.default_base_url(),
        default_headers: %{"Accept" => "application/json"},
        user_agent_prefix: "system-one-sdk",
      ...
      artifact_plan: %{
        generated_code_dir: "lib/system_one_sdk/generated",
        artifacts: [
    ...
    %{
      ...
      generated_code_dir:
        Keyword.get(
          opts,
          :generated_code_dir,
          Path.join(project_root, "lib/system_one_sdk/generated")
        ),
  ...
  @impl true
  def source_plugins, do: [SystemOneSDK.Codegen.Source.OpenAPI]
  @impl true
  def auth_plugins, do: []
  @impl true
