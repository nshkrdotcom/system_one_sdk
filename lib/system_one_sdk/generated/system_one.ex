defmodule SystemOneSDK.Generated.SystemOne do
  @moduledoc """
  Generated Typesafe Sdk operations module `SystemOneSDK.Generated.SystemOne`.
  """
  ...
  def create(client, params \\ %{}, opts \\ [])
    ...
    SystemOneSDK.Client.execute_generated_request(client, request)
  end
  ...
  defp build_create_request(client, params, opts)
    ...
    %{
      ...
      request_schema: SystemOneSDK.Generated.Schemas.SystemOneRequest,
      response_schemas: %{200 => SystemOneSDK.Generated.Schemas.SystemOneResponse},
