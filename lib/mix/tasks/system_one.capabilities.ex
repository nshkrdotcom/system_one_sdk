defmodule Mix.Tasks.Typesafe.Capabilities do
  ...
  def run(args) do
    ...
    client = SystemOneSDK.new_client(api_key: "capability-audit-only")
    ...
    registry = Map.new(SystemOneSDK.RuntimeCapabilities.names(), &{Atom.to_string(&1), &1})
    ...
    case SystemOneSDK.RuntimeCapabilities.check(client, requirements) do
      :ok -> :ok
