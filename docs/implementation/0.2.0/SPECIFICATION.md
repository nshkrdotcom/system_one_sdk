...
Keep SystemOneSDK.Generated.* and the existing Pristine execution/retry/auth
...
Add strict constructors under SystemOneSDK.Question.Noul/Choice/Score, each with
...
additively enriched. SystemOneSDK.Response and SystemOneSDK.Answer.* are helper
...
SystemOneSDK.Test creates an explicit test client using Pristine.Ports.Transport.
