...
- `SystemOneSDK.Response.values/1`, a narrow primary-value projection that preserves
  caller keys without introducing a second response hierarchy.
- Privacy-safe `[:system_one_sdk, :answer]` telemetry after semantic validation, with
...
- `SystemOneSDK.OTP.Server`, an opt-in bounded GenServer facade for non-blocking
...
- Focused live examples for Prepared composition/fingerprints, exact model catalog
  ...
  `SystemOneSDK.OTP.Server` integration. The example catalog now maps public 0.2-0.4
...
- Stable privacy-safe `SystemOneSDK.Response.metadata/1` and
  `SystemOneSDK.Error.metadata/1` accessors.
...
[0.4.0]: https://github.com/nshkrdotcom/system_one_sdk/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/nshkrdotcom/system_one_sdk/compare/v0.2.0...v0.3.0
[0.2.0]: https://github.com/nshkrdotcom/system_one_sdk/compare/v0.1.2...v0.2.0
[0.1.2]: https://github.com/nshkrdotcom/system_one_sdk/compare/v0.1.1...v0.1.2
[0.1.1]: https://github.com/nshkrdotcom/system_one_sdk/compare/v0.1.0...v0.1.1
[0.1.0]: https://github.com/nshkrdotcom/system_one_sdk/releases/tag/v0.1.0
